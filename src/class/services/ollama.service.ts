...
import HttpClient from "../common/http-client.class";
import { Response } from "../common/response.class";
import {
  IOllamaChatMessage,
  IOllamaChatRequest,
  IOllamaChatResponse,
...
} from "../../data/interfaces/ollama.interface";
...
class OllamaService {
  ...
  private get axios(): AxiosInstance {
    return HttpClient.getInstance({ baseURL: DEFAULT_OLLAMA_BASE, timeout: 30000 });
  }
