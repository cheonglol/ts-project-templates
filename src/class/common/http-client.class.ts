...
import { IStandardResponseBody, IErrorResponseBody } from "../../data/interfaces/transport.interface";
...
export default class HttpClient {
  ...
  public static resetForTests(): void {
    ...
    HttpClient.pendingRequests = new Map();
  }
  ...
  public static getInstance(config?: AxiosRequestConfig): AxiosInstance {
    if (!HttpClient.instance) {
      ...
      HttpClient.instance.interceptors.response.use(
        (response) => HttpClient.handleResponse(response),
        (error) => HttpClient.handleError(error)
      );
